...
export const Calculate: React.FC<CalculateProps> = props => {
    return (
        ...
        <button onClick={evt => props.clearButton(evt)} className="form__reset-button" name="reset" type="reset" disabled={!props.value}>
          ...
          <span>
            Очистить расчет и вернуть средние значения
          </span>
        </button>
      </div>
    )
